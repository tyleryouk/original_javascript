...
const MaterialUISwitch = styled(Switch)(({ theme }) => ({
  ...
  '& .MuiSwitch-switchBase': {
    ...
    '&.Mui-checked': {
      ...
      '& + .MuiSwitch-track': {
        opacity: 1,
        background: theme.palette.mode === ThemeMode.DARK ? '#8796A5' : '#aab4be'
      }
    }
  },
  '& .MuiSwitch-thumb': {
    background: theme.palette.mode === ThemeMode.DARK ? '#003892' : '#001e3c',
    width: 32,
    height: 32,
    '&:before': {
      content: "''",
...
const IOSSwitch = styled((props) => <Switch focusVisibleClassName=".Mui-focusVisible" disableRipple {...props} />)(({ theme }) => ({
  ...
  '& .MuiSwitch-switchBase': {
    ...
    '&.Mui-checked': {
      ...
      color: '#fff',
      '& + .MuiSwitch-track': {
        background: theme.palette.mode === ThemeMode.DARK ? '#2ECA45' : '#65C466',
        opacity: 1,
        border: 0
      },
  ...
  '& .MuiSwitch-track': {
    borderRadius: 26 / 2,
    background: theme.palette.mode === ThemeMode.DARK ? '#39393D' : '#E9E9EA',
    opacity: 1,
...
const AntSwitch = styled(Switch)(({ theme }) => ({
  ...
  '& .MuiSwitch-switchBase': {
    ...
    '&.Mui-checked': {
      ...
      '& + .MuiSwitch-track': {
        opacity: 1,
        background: theme.palette.mode === ThemeMode.DARK ? '#177ddc' : '#1890ff'
      }
    }
  },
  '& .MuiSwitch-thumb': {
  ...
  '& .MuiSwitch-track': {
    borderRadius: 16 / 2,
    opacity: 1,
    background: theme.palette.mode === ThemeMode.DARK ? 'rgba(255,255,255,.35)' : 'rgba(0,0,0,.25)',
    boxSizing: 'border-box'
  }
}));
